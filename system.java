...
public class system {
	...
	public static void main(String[] args) {
		...
		d_list.add(new doctor("Joseph", "Joestar", "N/A", "JJ", "password", 1111, 1, 80));
		d_list.add(new doctor("Jotaro", "Kujo", "N/A", "JK", "password", 2222, 1, 30));
		d_list.add(new doctor("Josuke", "Higashikata", "N/A", "JH", "password", 3333, 1, 16));
		d_list.add(new doctor("Giorno", "Giovanna", "N/A", "GG", "password", 4444, 1, 15));
		d_list.add(new doctor("Jolyne", "Cujoh", "N/A", "JC", "password", 5555, 1, 19));
	}
