...
public class system {
    ...
    public system(){
        ...
        d_list.add(new staff("Joseph", "Joestar", "N/A", "JJ", "password", "1/11/0011", 1111, 1));

        d_list.add(new staff("Jotaro", "Kujo", "N/A", "JK", "password", "2/22/0022", 2222, 1));

        d_list.add(new staff("Josuke", "Higashikata", "N/A", "JH", "password", "3/3/0033", 3333, 1));

        d_list.add(new staff("Giorno", "Giovanna", "N/A", "GG", "password", "4/4/0044", 4444, 1));

        d_list.add(new staff("Jolyne", "Cujoh", "N/A", "JC", "password", "5/5/0055", 5555, 1));
    ...
    public static void main(String[] args) {
		...
		d_list.add(new staff("Joseph", "Joestar", "N/A", "JJ", "password", "1/11/0011", 1111, 1, 80));

		d_list.add(new staff("Jotaro", "Kujo", "N/A", "JK", "password", "2/22/0022", 2222, 1, 30));

		d_list.add(new staff("Josuke", "Higashikata", "N/A", "JH", "password", "3/3/0033", 3333, 1, 16));

		d_list.add(new staff("Giorno", "Giovanna", "N/A", "GG", "password", "4/4/0044", 4444, 1, 15));

		d_list.add(new staff("Jolyne", "Cujoh", "N/A", "JC", "password", "5/5/0055", 5555, 1, 19));*/
    ...
    //official way to check if the staff exists
    ...
    //alternate way to check if the staff exists
